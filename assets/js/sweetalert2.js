...
var SweetAlert2Demo = function() {
    ...
    var initDemos = function() {
        ...
        $('.new_speed').click(function (e) {
            swal({
                title: '    تم تغيير السرعة إلى 16جيجا، لتاريخ 15/4/2021 ',
                text: "",
                type: 'success',
                showCancelButton: true,
        ...
        $('#m_sweetalert_demo_33').click(function (e) {
            swal({
                title: 'هل  أنت متأكد من حذف سند القبض؟',
                text: "",
                type: 'danger',
                icon: "danger",
                showCancelButton: true,
                confirmButtonText: 'حذف',
                confirmButtonClass: "my-btn confirm-btn add_btn",
            }).then(function (result) {
                if (result.value) {
                    swal(
                        'تم',
